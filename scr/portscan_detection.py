...
def load_dataset(file_path):
    ...
    df['Label'] = df['Label'].map({'BENIGN': 0, 'PortScan': 1})  # Map labels to numerical values
...
if __name__ == "__main__":
    ...
    df = load_dataset("../data/CICIDS_Dataset/Friday-WorkingHours-Afternoon-PortScan.pcap_ISCX.csv")
    ...
    model_based_class = ModelBasedClassImproved(Lambda = 0.0476)
